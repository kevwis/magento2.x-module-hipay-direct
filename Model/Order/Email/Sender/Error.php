 ...
 *
 */
namespace Kevwis\HipayDirect\Model\Order\Email\Sender;

use Kevwis\HipayDirect\Model\Order\Email\Container\Identity;
...
class Error
{
    ...
    protected function prepareTemplate(Order $order)
    {
        ...
        $this->eventManager->dispatch(
            'email_hipay_error_set_template_vars_before',
