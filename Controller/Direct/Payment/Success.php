        ...
        try {
            ...
            if ((bool) $session->getLastRealOrderId()) {
                ...
                if (!$order->isObjectNew()) {
                    ...
                    $order->addStatusHistoryComment("Customer come back from Hipay payment gateway with success")
                        ->setIsCustomerNotified(false)
                        ->save();

                    $this->messageManager->addSuccessMessage(new Phrase('Order\'s payment is pending capture'));
